...
intro_panel <- tabPanel(
  ...
  img("inequality.png", src = "www/inequality.png"),
  ...
  # text.
  p("This image shows that income inequality has ", strong("increased"), " significantly since the ", em("1980s"))
...
main_content <- mainPanel(
  ...
  a("http://gabriel-zucman.eu/usdina/")
)
